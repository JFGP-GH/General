...
#Region "Metodos"
    ...
    Private Sub CargarStrConfig()
        m_StrCon = My.Settings.StringConexion 'Estaba Comentado
        'Antes era lo siguiente:
        'm_StrCon = "Data Source=(local);Initial Catalog=dbFastFood;User ID=sa;Password=serversa"
        'm_StrCon = "Data Source=PAYE15;Initial Catalog=dbFastFood;Persist Security Info=True;User ID=sa;Password=serversa"
        m_StrCon = "Data Source=PAYE15\MSSQLSERVER2008;Initial Catalog=dbFastFood;Persist Security Info=True;User ID=sa;Password=server2008"

        My.Settings.StringConexion = m_StrCon 'Estaba Comentado
        My.Settings.Save() 'Estaba Comentado
    End Sub

    Public Sub GuardarStringConexion(ByVal cnx As String)
        'My.Settings.StringConexion = "Data Source=192.168.1.12;Initial Catalog=dbORBIS;User ID=sa;Password=TBS3rv3r" 'Estaba Comentado
        'My.Settings.StringConexion = "Data Source=192.168.1.10;Initial Catalog=dbORBIS;Integrated Security=True"  'Estaba Comentado
        My.Settings.StringConexion = "Data Source=PAYE15\MSSQLSERVER2008;Initial Catalog=dbFastFood;User ID=sa;Password=server2008" 'Estaba Comentado, instancia 2008
        My.Settings.StringConexion = "Data Source=PAYE15\MSSQLSERVER2008;Initial Catalog=dbFastFood;Integrated Security=True"  'Estaba Comentado , instancia 2008
        'My.Settings.StringConexion = "Data Source=PAYE15;Initial Catalog=dbFastFood;User ID=sa;Password=serversa" 'Estaba Comentado instancia 2019
        'My.Settings.StringConexion = "Data Source=PAYE15;Initial Catalog=dbFastFood;Integrated Security=True"  'Estaba Comentado, instancia 2019
        My.Settings.StringConexion = cnx
        My.Settings.Save()
